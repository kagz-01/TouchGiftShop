...
:root {
  ...
  --color-bg: /* neutral: white, off-white, or dark gray */ --color-surface:
    /* slightly different from bg */ /* 30% - Pick based on brand or context */
...
> **Remember**: Colors are decisions, not defaults. Every project deserves
> thoughtful selection based on its unique context.
