        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
            ...
            <div className="md:col-span-4 space-y-6">
              ...
              {/* Quick Gift Finder */}
              <Link href="/gift-finder" className="block bg-white/5 rounded-2xl p-4 border border-white/10 hover:bg-white/10 hover:border-gold/30 transition-all group">
                <p className="text-xs text-gold font-semibold uppercase tracking-wider mb-2">
                  Quick Gift Finder 🤖
                </p>
                <p className="text-white/60 text-sm">Ask Zawadi — our AI concierge — to find the perfect gift</p>
              </Link>
            </div>
