    ...
    <section className="py-10 md:py-14 bg-white">
      <div className="w-full page-container-capped">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="font-display text-2xl md:text-3xl font-bold text-brand-deep leading-tight">
            Two ways to go{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Link
            href="/gift-lab/pool"
            className="group relative block overflow-hidden bg-brand-bg rounded-[2rem] p-6 md:p-8 border border-brand/5 hover:border-brand/25 transition-all duration-500 hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] hover:-translate-y-1.5"
          >
            {/* Animated orb */}
            ...
            <div className="relative z-10 flex flex-col h-full gap-4">
              ...
              <div className="flex-1">
                ...
                <h3 className="font-display text-xl md:text-2xl font-bold text-brand-deep mb-2">
                  Start a Gift Pool
                </h3>
          ...
          <Link
            href="/gift-lab"
            className="group relative block overflow-hidden bg-blush rounded-[2rem] p-6 md:p-8 border border-brand/5 hover:border-brand/25 transition-all duration-500 hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] hover:-translate-y-1.5"
          >
            {/* Animated orb */}
